 ...
 * containing a chart and table. The daily minimum and max values and the</br>
 * temperatures recorded at 9am & 3pm are displayed in the chart.
 */
public class GuiDataWindow {
     ...
     * @throws IOException
     */
    public static void dataWindow( Station site ) throws IOException {
        site.loadData();
        site.updateData();
